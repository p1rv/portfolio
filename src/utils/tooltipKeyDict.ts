...
type ITooltipKeyDict = {
  [key in keyof Omit<IForecast, "time">]: { label: ILanguageObject; unit: string };
};

export const tooltipKeyDict: ITooltipKeyDict = {
  temp_max: {
  ...
  wind_dir: {
    label: { EN: "Wind direction", PL: "Kierunek wiatru" },
    unit: "°",
  },
};
