...
export const ContactIcon: React.FC<IIconProps> = memo(({ stroke = "#fefcfbff", selected, className = "w-8 h-8" }) => {
  ...
  const envelopeHatchClasses = classNames(pathClasses, {
    ...
    "translate-y-1/3 group-hover:translate-y-0 scale-y-[0.1] group-hover:scale-y-100": !selected,
  });
  return (
    <svg
      width="200mm"
