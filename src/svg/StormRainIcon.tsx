...
const StormRain: React.FC<IIconProps> = memo(({ stroke = "#fefcfbff", fill, ...rest }) => {
  return (
    <svg
      width="40px"
      height="40px"
    ...
    >
      <g>
        ...
        <path
          ...
          strokeDasharray="none"
          strokeOpacity="1"
          d="m 72.28729,153.83607 -7.85929,17"
        />
        <path
          fill="none"
          stroke="#1282a2"
          ...
          strokeDasharray="none"
          strokeOpacity="1"
          d="m 109.28729,153.83607 -7.85929,17"
        />
        <path
          fill="#eca400"
          fillOpacity="1"
          ...
          strokeDasharray="none"
          strokeOpacity="1"
          d="M 106,120 81.013632,151 90,151 81,176 105.98746,145 97,145 Z"
        />
      </g>
    </svg>
  );
